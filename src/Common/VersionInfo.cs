namespace Geocrest
{
    ...
    internal class VersionInfo
    {
        ...
        /// Use this for the enterprise model framework libraries.
        /// </remarks>
        internal const string ModelProductVersion = "1.0.0-alpha2";
        /// <summary>
        /// Specifies the product version for Silverlight enterprise model.
        /// </summary>
        internal const string ModelSilverlightProductVersion = "1.0.0-alpha2 for Silverlight";
        ...
        /// Use this for the core framework libraries.
        /// </remarks>
        internal const string GlobalProductVersion = "1.0.0-alpha2";
        /// <summary>
        /// Specifies the product version for Silverlight
        /// </summary>
        internal const string GlobalSilverlightProductVersion = "1.0.0-alpha2 for Silverlight";
        /// <summary>
