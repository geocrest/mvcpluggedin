namespace Geocrest
{
    ...
    internal class VersionInfo
    {
        ...
        /// Use this for the enterprise model framework libraries.
        /// </remarks>
        internal const string ModelProductVersion = "1.0.0-beta1";
        /// <summary>
        /// Specifies the product version for Silverlight enterprise model.
        /// </summary>
        internal const string ModelSilverlightProductVersion = "1.0.0-beta1 for Silverlight";
        ...
        /// </remarks>
        internal const string GlobalFileVersion = "1.0.5418.30264";
        /// <summary>
        /// Specifies the product version to display in the Details tab of Windows Explorer.
        /// </summary>
        /// <remarks>
        /// Use this for the core framework libraries.
        /// </remarks>
        internal const string GlobalProductVersion = "1.0.0-beta1";
        /// <summary>
        /// Specifies the product version for Silverlight
        /// </summary>
        internal const string GlobalSilverlightProductVersion = "1.0.0-beta1 for Silverlight";
        /// <summary>
