namespace Geocrest.Model
{
    ...
    /// <summary>
    /// Wraps the <see cref="T:System.Net.UploadStringCompletedEventArgs"/> class to enable unit testing.
    /// </summary>
    public class WrappedUploadStringCompletedEventArgs : WrappedAsyncCompletedEventArgs
    {
        /// <summary>
        ...
        public WrappedUploadStringCompletedEventArgs(string result, Exception error, bool cancelled, object userState, Uri url)
            : base(typeof(string),result, error, cancelled, userState, url)
        {
        ...
        public WrappedUploadStringCompletedEventArgs(UploadStringCompletedEventArgs args)
